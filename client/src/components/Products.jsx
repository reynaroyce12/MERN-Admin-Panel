...
const Product = ({
    ...
    return (
        <Card sx={{ backgroundColor: theme.palette.background.alt, backgroundImage: 'none', borderRadius: '0.55rem'}}>
            <CardContent>
            ...
            <CardActions>
                <Button variant='primary' size='small' onClick={() => setIsExpanded(!isExpanded)}>{isExpanded ? 'See less' : 'See more'}</Button>
            </CardActions>
